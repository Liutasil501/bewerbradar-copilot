...
- **Paywall Limits & Templates:** Harte Limits für "Free"-Nutzer eingeführt. Sie können nun maximal 1 Lebenslauf erstellen und haben nur Zugriff auf 5 Free-Templates (classic, modern, minimal, professional, two-column). Premium-Templates sind mit einem Schloss versehen und triggern einen Paywall-Upsell. Die Limits werden auch serverseitig in der `POST /api/resume` Route erzwungen.
