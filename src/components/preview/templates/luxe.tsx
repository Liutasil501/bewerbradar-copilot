        ...
        {((content as WorkExperienceContent).items || []).map((item: any) => (
          <div key={item.id} className="border-l-2 pl-4" style={{ borderColor: GOLD }}>
            <div className="flex items-baseline justify-between">
              ...
              <span className="shrink-0 text-xs italic" style={{ color: '#a8a29e' }}>{item.startDate} &ndash; {item.endDate || (item.current ? (lang === 'de' ? 'Heute' : 'Present') : '')}</span>
            </div>
            ...
            {item.technologies?.length > 0 && (
              <p className="mt-0.5 text-xs italic" style={{ color: '#a8a29e' }}>{lang === 'de' ? 'Technologien' : 'Tech'}: {item.technologies.join(', ')}</p>
            )}
        ...
        {((content as EducationContent).items || []).map((item: any) => (
          <div key={item.id} className="border-l-2 pl-4" style={{ borderColor: GOLD }}>
            <div className="flex items-baseline justify-between">
              ...
              <span className="shrink-0 text-xs italic" style={{ color: '#a8a29e' }}>{item.startDate} &ndash; {item.endDate || (lang === 'de' ? 'Heute' : 'Present')}</span>
            </div>
        ...
        {((content as ProjectsContent).items || []).map((item: any) => (
          <div key={item.id} className="border-l-2 pl-4" style={{ borderColor: GOLD }}>
            <div className="flex items-baseline justify-between">
              ...
              {item.startDate && (
                <span className="shrink-0 text-xs italic" style={{ color: '#a8a29e' }}>{item.startDate} {'\u2013'} {item.endDate || (lang === 'de' ? 'Heute' : 'Present')}</span>
              )}
            </div>
