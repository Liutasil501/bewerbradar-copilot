        ...
        <div className="mb-6 space-y-1.5 text-xs">
          {pi.age && (
            <div className="flex items-start gap-2 text-blue-100">
              <span className="shrink-0 text-blue-300">{getLabel('age', resume.language)}:</span>
              <span>{pi.age}</span>
            </div>
          )}
          {pi.politicalStatus && (
            <div className="flex items-start gap-2 text-blue-100">
              <span className="shrink-0 text-blue-300">{getLabel('politicalStatus', resume.language)}:</span>
              <span>{pi.politicalStatus}</span>
            </div>
          )}
          {pi.gender && (
            <div className="flex items-start gap-2 text-blue-100">
              <span className="shrink-0 text-blue-300">{getLabel('gender', resume.language)}:</span>
              <span>{pi.gender}</span>
            </div>
          )}
          {pi.ethnicity && (
            <div className="flex items-start gap-2 text-blue-100">
              <span className="shrink-0 text-blue-300">{getLabel('ethnicity', resume.language)}:</span>
              <span>{pi.ethnicity}</span>
            </div>
          )}
          {pi.hometown && (
            <div className="flex items-start gap-2 text-blue-100">
              <span className="shrink-0 text-blue-300">{getLabel('hometown', resume.language)}:</span>
              <span>{pi.hometown}</span>
            </div>
          )}
          {pi.maritalStatus && (
            <div className="flex items-start gap-2 text-blue-100">
              <span className="shrink-0 text-blue-300">{getLabel('maritalStatus', resume.language)}:</span>
              <span>{pi.maritalStatus}</span>
            </div>
          )}
          {pi.yearsOfExperience && (
            <div className="flex items-start gap-2 text-blue-100">
              <span className="shrink-0 text-blue-300">{getLabel('yearsOfExperience', resume.language)}:</span>
              <span>{pi.yearsOfExperience}</span>
            </div>
          )}
          {pi.educationLevel && (
            <div className="flex items-start gap-2 text-blue-100">
              <span className="shrink-0 text-blue-300">{getLabel('educationLevel', resume.language)}:</span>
              <span>{pi.educationLevel}</span>
            </div>
          )}
          {pi.email && (
            <div className="flex items-start gap-2 text-blue-100">
              <span className="shrink-0 text-blue-300">{getLabel('email', resume.language)}:</span>
              <span className="break-all">{pi.email}</span>
            </div>
          )}
          {pi.phone && (
            <div className="flex items-start gap-2 text-blue-100">
              <span className="shrink-0 text-blue-300">{getLabel('phone', resume.language)}:</span>
              <span>{pi.phone}</span>
            </div>
          )}
          {pi.wechat && (
            <div className="flex items-start gap-2 text-blue-100">
              <span className="shrink-0 text-blue-300">{getLabel('wechat', resume.language)}:</span>
              <span>{pi.wechat}</span>
            </div>
          )}
          {pi.location && (
            <div className="flex items-start gap-2 text-blue-100">
              <span className="shrink-0 text-blue-300">{getLabel('location', resume.language)}:</span>
              <span>{pi.location}</span>
            </div>
          )}
          {pi.website && (
            <div className="flex items-start gap-2 text-blue-100">
              <span className="shrink-0 text-blue-300">{getLabel('website', resume.language)}:</span>
              <span className="break-all">{pi.website}</span>
            </div>
          )}
          {pi.linkedin && (
            <div className="flex items-start gap-2 text-blue-100">
              <span className="shrink-0 text-blue-300">{getLabel('linkedin', resume.language)}:</span>
              <span className="break-all">{pi.linkedin}</span>
            </div>
          )}
          {pi.github && (
            <div className="flex items-start gap-2 text-blue-100">
              <span className="shrink-0 text-blue-300">{getLabel('github', resume.language)}:</span>
