        ...
        {((content as WorkExperienceContent).items || []).map((item: any) => (
          <div key={item.id} className="rounded-lg border p-3" style={{ borderColor: TEAL_500, backgroundColor: TEAL_50 }}>
            <div className="flex items-baseline justify-between">
              ...
              <span className="shrink-0 text-xs font-medium" style={{ color: TEAL_500 }}>{item.startDate} - {item.endDate || (item.current ? (resume.language === 'de' ? 'Heute' : 'Present') : '')}</span>
            </div>
        ...
        {((content as EducationContent).items || []).map((item: any) => (
          <div key={item.id} className="rounded-lg border p-3" style={{ borderColor: TEAL_500, backgroundColor: TEAL_50 }}>
            <div className="flex items-baseline justify-between">
              ...
              <span className="shrink-0 text-xs font-medium" style={{ color: TEAL_500 }}>{item.startDate} - {item.endDate || (resume.language === 'de' ? 'Heute' : 'Present')}</span>
            </div>
