...
IMPORTANT: Detect the primary language of the resume content. You MUST respond entirely in the same language as the resume. If the resume is written in German, all your output (summary, suggestions, sectionTitle) must be in German. If in English, respond in English. Match the resume's language exactly.
